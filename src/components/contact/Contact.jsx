...
import { FaFacebook, FaWhatsapp, FaTwitter, FaEnvelope, FaInstagram } from "react-icons/fa";
...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm("service_096p225", "template_mmr696h", form.current, "m-2zcP03M9JbtvoJT").then(
      (res) => {
    ...
    <div id="contact-main">
      ...
      <div class="wrapper">
        <ul>
          ...
          <li class="twitter">
            <a href="#contact-main" target="_blank" rel="noreferrer">
          ...
          <li class="google">
            <a id="emailMe" href="mailto:imdevgan@gmail.com" target="_blank" rel="noreferrer">
      ...
      <div className="form">
        <form action="" className="entry" onSubmit={sendEmail} ref={form}>
          <div className="inputDiv">
            <input className="input ip1" name="name" type="text" placeholder="Name"></input>

            <input className="input ip2" name="user-email" type="text" placeholder="Email"></input>
          </div>
          <br />

          <input className="message subject" type="text" placeholder="Subject"></input>
          <br />

          <textarea name="message" id="Message" cols="93" rows="15" placeholder="Message"></textarea>
          <br />
